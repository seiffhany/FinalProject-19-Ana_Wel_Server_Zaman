...
public class JwtTokenProvider {
    ...
    // * @param userDetails The user details object containing the username and
    // other information.
    ...
    /**
     * Validates token only by checking expiration.
     *
     * @param token JWT token to validate.
     * @return true if token is not expired and can be trusted.
     */
