...
import com.example.notification_service.exception.EmailNotificationException;
...
//            notificationRepository.save(notification);
            ...
            throw new EmailNotificationException("Failed to send email to " + notification.getRecipientEmail(), e);
        }
    }
}