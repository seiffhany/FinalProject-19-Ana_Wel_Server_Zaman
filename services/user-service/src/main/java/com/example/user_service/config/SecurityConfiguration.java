...
/**
 * SecurityConfiguration class that configures the security settings for the application.
 * It sets up the security filter chain, authentication provider, and JWT authentication filter.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfiguration {
     ...
     * and specifies which endpoints are publicly accessible and which require authentication.
     *
...
//                                        apiBaseUrl + "/auth/authenticate", // Permit authenticate endpoint
                ...
                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS)) // Use stateless session management which means no session will be created or used by Spring Security
