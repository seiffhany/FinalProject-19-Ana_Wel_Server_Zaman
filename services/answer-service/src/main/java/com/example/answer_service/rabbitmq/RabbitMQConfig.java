...
public class RabbitMQConfig {
    ...
    @Bean
    public Binding answerBinding(@Qualifier("questionQueue") Queue answerQueue,
            @Qualifier("questionExchange") TopicExchange answerExchange) {
        return BindingBuilder
                .bind(answerQueue)
                .to(answerExchange)
                .with(ANSWER_ROUTING_KEY);
    ...
    @Bean
    public Binding questionBinding(@Qualifier("questionQueue") Queue questionQueue, TopicExchange questionExchange) {
        return BindingBuilder
                .bind(questionQueue)
                .to(questionExchange)
    ...
    @Bean
    public Binding questionDeletedBinding(@Qualifier("questionDeletedQueue") Queue questionDeletedQueue,
            TopicExchange questionDeletedExchange) {
        return BindingBuilder
